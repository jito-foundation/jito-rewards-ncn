...
impl UpdateWeightTable {
  pub fn instruction(&self, args: UpdateWeightTableInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: UpdateWeightTableInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = UpdateWeightTableInstructionData::new().try_to_vec().unwrap();
    ...
    let accounts = UpdateWeightTable {
          ...
          let args = UpdateWeightTableInstructionArgs {
                                                              ncn_epoch: self.ncn_epoch.clone().expect("ncn_epoch is not set"),
                                                                  weight_numerator: self.weight_numerator.clone().expect("weight_numerator is not set"),
                                                                  weight_denominator: self.weight_denominator.clone().expect("weight_denominator is not set"),
                                    };
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = UpdateWeightTableInstructionArgs {
                                                              ncn_epoch: self.instruction.ncn_epoch.clone().expect("ncn_epoch is not set"),
                                                                  weight_numerator: self.instruction.weight_numerator.clone().expect("weight_numerator is not set"),
                                                                  weight_denominator: self.instruction.weight_denominator.clone().expect("weight_denominator is not set"),
                                    };
